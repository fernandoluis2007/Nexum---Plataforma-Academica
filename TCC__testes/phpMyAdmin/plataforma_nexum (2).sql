...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10-Out-2024 às 02:33
...
CREATE TABLE `notaalunos` (
  ...
  `media_percentual` float DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `notaalunos` (`id`, `Primeira_Avaliação`, `Segunda_Avaliação`, `Terceira_Avaliação`, `Prova_Final`, `Nome_Aluno`, `media_percentual`) VALUES
(9, 5, 2, 8, 10, 'Louis', 62.5),
(10, 5, 1, 4, 2, 'Bob', 30),
(11, 1, 2, 4, 5, 'Thigas', 30),
(12, 1, 2, 1, 5, 'JoaoGabriel', 10);

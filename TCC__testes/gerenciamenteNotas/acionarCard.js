...
const card2 = document.querySelector('.dois');
...
function cardClicado() {
    ...
    cardAll.forEach((cardAllf) => {
        cardAllf.addEventListener('click', function (event) {
            ...
            const sectionNotas = document.getElementById('sectionNotas');
            ...
            if(clickedCard.classList.contains('active') && clickedCard.classList.contains('um')){
                sectionNotas.style.display = 'flex';
            ...
            if(clickedCard.classList.contains('active') && clickedCard.classList.contains('dois')){
                sectionListaNotas.style.display = 'flex';
                cardAllsection.style.display = 'flex';
                cardAllsection.style.flexDirection = 'column';
                card2.style.display = 'none';
            }else{
                sectionListaNotas.style.display = 'none';
            }

    ...
    <header class="cabeçario">
        ...
        <?php include '../../home/backend/headerProf.php'; ?>
            ...
            <div class="opcoes-areas">
                ...
                <h1 class="opcoes-tela camada"><a class="link" href="../../Agenda/views/manager/index.php">Calendário</a></h1>
        ...
        <nav>
            ...
            <div class="wrapper">
                <ul>
                    ...
                    <li><a href="../../Agenda/views/manager/index.php">Calendário</a></li>
                </ul>
            </div>
        </nav>
    </header>
    <section class="container">
        <main>
            ...
            <div class="card-container">
                ...
                <div class="card">
                    <h3><a class="link" href="./../../gerenciamenteNotas/lancarNotas.php">Notas</a></h3>
